...
export default function Experience() {
  ...
  return (
    <section className="education section" id="experience" ref={ref}>
      <div className="education__bg-accent" />

      <div className="container">
        <ScrollReveal className="education__header">
          <span className="section-eyebrow">My Career</span>
          <h2 className="section-title">Experience</h2>
          <p className="section-subtitle">
            Pengalaman profesional saya dalam industri teknologi
          </p>
        </ScrollReveal>
              ...
              >
                ...
                >
                  ...
                  <div className="education__degree-row">
                    <FiBriefcase className="education__degree-icon" />
                    <h3 className="education__degree">{item.title}</h3>
                  </div>

                  {/* School/Company */}
                  <p className="education__school">{item.company}</p>
